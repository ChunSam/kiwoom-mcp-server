...
| `get_ranking` | 상승률/하락률/거래량/거래대금 상위 + 시가대비 등락률(체결강도 포함) | ka10027/30/32, ka10028 |
...
| `get_foreign_intraday` | 장중 외국인 순매수/순매도 상위 종목 (정규장 실시간) | ka10063 |
| `get_broker_activity` | 종목별 거래원(증권사) 매수/매도 상위 5 + 외국계 창구 표시, 또는 시장 전체 외국계 창구 순매매 상위 | ka10002, ka10102, ka10037 |
...
| `get_foreign_holding` | 외국인 보유(한도) 동향 — 종목별 추이, 또는 시장 전체 순위(한도소진율 증가 / 기간 누적 순매매) | ka10008, ka10036, ka10034 |
