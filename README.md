...
| `get_etf_returns` | ETF 기간별 수익률 vs 대상지수 + 일별 NAV·괴리율·추적오차 추이, 일자별 외국인·기관 순매수 | ka40001, ka40003, ka40008 |
...
| `get_program_trading` | 프로그램 매매 상위 + 추이 (일자별/시간대별/종목별, 코스피/코스닥) + 종목 시간대별·차익거래 잔고 | ka90003, ka90010, ka90005, ka90013, ka90008, ka90006 |
