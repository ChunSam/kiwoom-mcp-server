  ...
  server.registerTool(
    "get_theme_groups",
    {
      ...
      description:
        ...
        "골라야 하고(기본 30개는 등락률 상위라 원하는 테마가 없으면 limit을 100까지 올리세요). " +
        "'반도체'처럼 **테마명과 업종명이 겹치는 이름**이 있는데, 사용자가 '테마'라고 물었으면 여기가 맞고 " +
        "get_sector_stocks는 KRX 표준 **업종** 분류입니다 — 사용자가 쓴 말을 따르세요. " +
